...
class TextAnalysiser:
    ...
    def analysis(self,rawInputData):
        ...
        output = {
            ...
            'number of sentence':numberOfSentence,
            'number of word' : numberOfWord,
            'number of distinct word': numberOfDistinctWord,
            'number of syllable':numberOfSyllable,
            'number of distinct syllable':numberofDistinctSyllable,
            'number of character':numberOfCharacter,
            'number of proper noun':numberOfProperNouns,
            'number of distinct proper noun':numberOfProperNouns,
            'aslw':aslw,
            'asls':asls,
            'aslc':aslc,
            'awls':awls,
